...
## Features
- Water intake tracking with custom quantity support
- Health Connect integration for steps, calories, and sleep data
- Smart hydration reminder notifications
...
- Flutter SDK 3.19+
- Android API 26+
- Health Connect support requires Android API 28+
